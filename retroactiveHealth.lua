-- =====================================================
-- Retroactive Health Official Public Release - TES3MP 0.8.1
...
-- ====================== CONFIG =======================
local allowHealthDecrease = false    -- If true, allows HP to be corrected downwards (will affect boosted characters). Staff characters are not affected
